...
class MaintenanceMode extends Page
{
    ...
    public function mount(): void
    {
        $this->data = [
            ...
            'allowed_ips' => SystemSetting::get('maintenance_allowed_ips', '127.0.0.1'),
                ...
                Section::make('Maintenance Configuration')
                    ->schema([
                        ...
                        TextInput::make('allowed_ips')
                            ...
                            ->helperText('Comma-separated list of IP addresses that can bypass maintenance mode')
    ...
    public function save(): void
    {
        ...
        SystemSetting::set('maintenance_allowed_ips', $data['allowed_ips'], 'string');
    ...
    public function laravelDown(): void
    {
        ...
        $allowedIps = $this->data['allowed_ips'] ?? '127.0.0.1';
