...
namespace App\Http\Controllers\DokterGigi;
...
class DashboardController extends Controller
{
    public function index()
    {
        ...
        // Check if user has dokter_gigi role
        if (!$user->hasRole('dokter_gigi')) {
        ...
        return view('dokter-gigi.dashboard', compact(
            'user',
            'jaspelData',
            'totalJaspel',
            'totalTransactions',
    ...
    public function jaspel(Request $request)
    {
        ...
        return view('dokter-gigi.jaspel', compact('user', 'jaspelData'));
    }
}