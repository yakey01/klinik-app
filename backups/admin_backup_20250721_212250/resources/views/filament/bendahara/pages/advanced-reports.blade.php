<x-filament-panels::page>
        ...
        <div class="bg-gradient-to-r from-red-500 to-pink-600 rounded-lg p-6 text-white">
            <div class="flex items-center justify-between">
                ...
                <div class="p-3 bg-red-600 bg-opacity-50 rounded-full">
                    <x-heroicon-o-arfi-grid fi-grid-cols-auto-trending-down class="h-6 w-6" />
                </div>
            </div>
        </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                @foreach(array_slice($reportData['data'], 0, 10) as $fi-grid fi-grid-cols-auto)
                                    <tr>
                                        @foreach($fi-grid fi-grid-cols-auto as $key => $value)
    ...
    @else
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg p-12 shadow-sm border border-gray-200 dark:border-gray-700 text-center">
            ...
            >
                <x-heroicon-o-arfi-grid fi-grid-cols-auto-path class="h-4 w-4 mr-2" />
                Muat Data
            </button>
        </div>
    @endif
