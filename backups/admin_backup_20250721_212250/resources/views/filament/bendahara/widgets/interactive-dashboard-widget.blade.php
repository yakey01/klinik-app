                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <div class="flex items-center mt-1">
                                <x-filament::icon
                                    :icon="$kpiData['pendapatan']['trend'] === 'up' ? 'heroicon-o-arfi-grid fi-grid-cols-auto-trending-up' : 'heroicon-o-arfi-grid fi-grid-cols-auto-trending-down'"
                        ...
                        <div class="p-3 bg-success-100 dark:bg-success-900 rounded-full">
                            <x-filament::icon
                                icon="heroicon-o-arfi-grid fi-grid-cols-auto-trending-up"
                ...
                <x-filament::fi-card>
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <div class="flex items-center mt-1">
                                <x-filament::icon
                                    :icon="$kpiData['pengeluaran']['trend'] === 'up' ? 'heroicon-o-arfi-grid fi-grid-cols-auto-trending-up' : 'heroicon-o-arfi-grid fi-grid-cols-auto-trending-down'"
                ...
                <x-filament::fi-card>
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <div class="flex items-center mt-1">
                                <x-filament::icon
                                    :icon="$kpiData['profit']['value'] >= 0 ? 'heroicon-o-arfi-grid fi-grid-cols-auto-trending-up' : 'heroicon-o-arfi-grid fi-grid-cols-auto-trending-down'"
