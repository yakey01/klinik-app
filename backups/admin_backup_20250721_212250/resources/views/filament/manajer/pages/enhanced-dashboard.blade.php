<x-filament-panels::page>
    ...
    <div class="executive-dashboard-fi-container">
        {{-- Dashboard Header --}}
        ...
        <div class="executive-widgets-grid">
            ...
            <div class="widget-fi-grid fi-grid-cols-auto">
                <div class="widget-fi-card hero-stats">
                    <livewire:app.filament.manajer.widgets.manajer-hero-stats-widget />
                </div>
                <div class="widget-fi-card financial-insights">
                    <livewire:app.filament.manajer.widgets.manajer-financial-insights-widget />
                </div>
                <div class="widget-fi-card team-performance">
    ...
    <style>
        .executive-dashboard-fi-container {
            max-width: 1400px;
            margin: 0 auto;
            padding: 0 24px;
        }
        ...
        .widget-fi-grid fi-grid-cols-auto {
            display: grid;
        ...
        .widget-fi-card:hover {
            transform: translateY(-4px);
            box-shadow: 0 8px 25px rgba(0, 0, 0, 0.15);
            border-color: rgba(99, 102, 241, 0.3);
        }

        .widget-fi-card::before {
            content: '';
            position: absolute;
            top: 0;
            left: 0;
        ...
        .widget-fi-card:nth-child(2) {
            animation-delay: 0.1s;
        }

        .widget-fi-card:nth-child(3) {
