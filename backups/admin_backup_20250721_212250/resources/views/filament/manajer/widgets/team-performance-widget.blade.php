<x-filament-widgets::widget>
    <x-filament::section>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div class="performance-fi-card paramedis-fi-card">
            ...
            <div class="performance-fi-card non-paramedis-fi-card">
                <div class="performance-header">
            ...
            {{-- Dokter Performance --}}
            <div class="performance-fi-card dokter-fi-card">
                <div class="performance-header">
    ...
    <style>
        ...
        .performance-fi-card:hover {
            transform: translateY(-2px);
            box-shadow: 0 8px 25px rgba(0, 0, 0, 0.1);
        }

        .dark .performance-fi-card {
