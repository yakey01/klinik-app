        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center">
                <div class="p-3 bg-blue-100 dark:bg-blue-900 rounded-full">
                    <x-heroicon-o-arfi-grid fi-grid-cols-auto-down-tray class="h-6 w-6 text-blue-600" />
                </div>
                <div class="ml-4">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            <div class="flex items-center">
                <div class="p-3 bg-green-100 dark:bg-green-900 rounded-full">
                    <x-heroicon-o-arfi-grid fi-grid-cols-auto-up-tray class="h-6 w-6 text-green-600" />
                </div>
                <div class="ml-4">
        ...
        <div class="p-6">
            @if($recentImports->isEmpty())
                <div class="text-center py-8">
                    <x-heroicon-o-arfi-grid fi-grid-cols-auto-down-tray class="mx-auto h-12 w-12 text-gray-400" />
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-4 mt-1">
                                        ...
                                        @if($import->processed_fi-grid fi-grid-cols-autos > 0)
                                            <span class="text-xs text-gray-500">
                                                {{ number_format($import->processed_fi-grid fi-grid-cols-autos) }} fi-grid fi-grid-cols-autos processed
                                            </span>
                                        @endif
                                    </div>
                                </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow">
        ...
        <div class="p-6">
            @if($recentExports->isEmpty())
                <div class="text-center py-8">
                    <x-heroicon-o-arfi-grid fi-grid-cols-auto-up-tray class="mx-auto h-12 w-12 text-gray-400" />
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    ...
                                    <div class="flex items-center space-x-4 mt-1">
                                        ...
                                        @if($export->exported_fi-grid fi-grid-cols-autos > 0)
                                            <span class="text-xs text-gray-500">
                                                {{ number_format($export->exported_fi-grid fi-grid-cols-autos) }} fi-grid fi-grid-cols-autos exported
                                            </span>
                                        @endif
                                        @if($export->file_size)
                                            <span class="text-xs text-gray-500">
                            ...
                            <div class="flex items-center space-x-2">
                                ...
                                @elseif($export->status === 'completed')
                                    @if($export->isDownloadable())
                                        ...
                                        >
                                            <x-heroicon-o-arfi-grid fi-grid-cols-auto-down-tray class="h-4 w-4 mr-1" />
                                            Download
                                        </button>
                                    @else
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div class="text-center">
                    <div class="text-3xl font-bold text-blue-600">
                        {{ number_format($importStats['total_fi-grid fi-grid-cols-autos_processed'] ?? 0) }}
                    </div>
                    <div class="text-sm text-gray-500">Total Rows Processed</div>
                </div>
                <div class="text-center">
                    <div class="text-3xl font-bold text-green-600">
                        {{ number_format($exportStats['total_fi-grid fi-grid-cols-autos_exported'] ?? 0) }}
                    </div>
