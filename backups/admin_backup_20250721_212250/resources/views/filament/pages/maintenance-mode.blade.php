<x-filament-panels::page>
    <div class="space-y-6">
        <!-- Current Status Card -->
        <div class="filament-fi-card bg-white rounded-lg shadow-sm border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6">
        ...
        <!-- Alert Banner -->
        @if(app()->isDownForMaintenance())
            <div class="filament-fi-card bg-red-50 border border-red-200 rounded-lg p-4 dark:bg-red-900 dark:border-red-800">
        ...
        @elseif(\App\Models\SystemSetting::get('maintenance_mode', false))
            <div class="filament-fi-card bg-yellow-50 border border-yellow-200 rounded-lg p-4 dark:bg-yellow-900 dark:border-yellow-800">
                <div class="flex items-center">
        ...
        <!-- Help Section -->
        <div class="filament-fi-card bg-blue-50 border border-blue-200 rounded-lg p-4 dark:bg-blue-900 dark:border-blue-800">
