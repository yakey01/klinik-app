<div class="space-y-8">
    ...
    <!-- Statistics Cards -->
    <x-admin-fi-card title="Statistics Cards" 
                  subtitle="Responsive stat fi-cards for displaying key metrics"
    ...
    <!-- Buttons -->
    <x-admin-fi-card title="Buttons" 
                  subtitle="Various button styles and states"
                  icon="heroicon-o-cursor-arfi-grid fi-grid-cols-auto-rays"
                  :collapsible="true">
        <div class="space-y-6">
            <!-- Button Variants -->
            <div>
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-3">
                    ...
                    <x-admin-button 
                        icon="heroicon-o-arfi-grid fi-grid-cols-auto-right" 
                        icon-position="right">
                        Icon Right
                    </x-admin-button>
                    <x-admin-button 
    ...
    <!-- Progress Bars -->
    <x-admin-fi-card title="Progress Bars" 
    ...
    <!-- Responsive Grid -->
    <x-admin-fi-card title="Responsive Grid System" 
    ...
    <!-- Typography -->
    <x-admin-fi-card title="Typography" 
    ...
    <x-admin-fi-card title="CSS Classes Reference" 
        ...
        <div class="space-y-6">
            ...
            <div class="bg-gray-50 dark:bg-gray-900 p-4 rounded-lg">
                ...
                <div class="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                    <div><code class="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded">.admin-fi-btn fi-btn-primary</code> - Primary button style</div>
                    <div><code class="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded">.admin-fi-btn fi-btn-primary</code> - Secondary button style</div>
                    <div><code class="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded">.admin-fi-btn fi-btn-primary</code> - Outline button style</div>
                    <div><code class="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded">.admin-fi-btn fi-btn-primary</code> - Ghost button style</div>
                    <div><code class="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded">.admin-fi-btn fi-btn-primary</code> - Small button size</div>
                    <div><code class="bg-gray-200 dark:bg-gray-700 px-2 py-1 rounded">.admin-fi-btn fi-btn-primary</code> - Large button size</div>
                </div>
            </div>
