<x-filament-panels::page>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow dark:shadow-lg border dark:border-gray-700 mb-6 transition-all duration-200">
        ...
        <div class="p-6">
            <div id="monthlyTrendsChart" style="height: 300px;" class="chart-fi-container"></div>
        </div>
    </div>
    ...
    <script>
        ...
        const petugasDashboardObserver = new MutationObserver(function(mutations) {
        ...
        petugasDashboardObserver.observe(document.documentElement, {
            attributes: true,
