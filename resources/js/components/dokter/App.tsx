            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400 transition-colors duration-300">Healthcare Worker</p>
                </div>
              </div>
      ...
      >
        <Card className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm shadow-2xl border-0 transition-colors duration-300">
          <CardHeader className="text-center pb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 transition-colors duration-300">Healthcare Worker Portal</p>
          </CardHeader>
