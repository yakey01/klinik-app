...
<head>
    ...
    <title>Dashboard Dokter - Dokterku</title>
...
<body class="bg-gray-50 dark:bg-gray-900 font-sans antialiased h-full overflow-x-hidden">
    <div class="flex min-h-screen">
        ...
        <aside id="sidebar" class="fixed inset-y-0 left-0 z-50 w-80 bg-gray-900 text-white transform -translate-x-full transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0">
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href="/dokter/dokter-presensis" class="flex items-center space-x-3 px-4 py-3 rounded-md hover:bg-gray-800 transition-all duration-200 group">
                ...
                <a href="/dokter/jaspel-dokters" class="flex items-center space-x-3 px-4 py-3 rounded-md hover:bg-gray-800 transition-all duration-200 group">
                ...
                <a href="/dokter/tindakan-dokters" class="flex items-center space-x-3 px-4 py-3 rounded-md hover:bg-gray-800 transition-all duration-200 group">
        ...
        <main class="flex-1 lg:ml-0">
            ...
            <div class="p-4 lg:p-8 space-y-8 animate-fade-in">
                ...
                <div class="animate-slide-up">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 text-lg">Dr. {{ $user->name }}</p>
                </div>
                ...
                <div class="animate-bounce-in" style="animation-delay: 0.6s">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <a href="/dokter/dokter-presensis" class="glass rounded-xl p-6 text-center hover:bg-opacity-10 hover:bg-blue-500 transition-all duration-300 group block">
                        ...
                        <a href="/dokter/jaspel-dokters" class="glass rounded-xl p-6 text-center hover:bg-opacity-10 hover:bg-green-500 transition-all duration-300 group block">
                        ...
                        <a href="/dokter/tindakan-dokters" class="glass rounded-xl p-6 text-center hover:bg-opacity-10 hover:bg-purple-500 transition-all duration-300 group block">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('Dashboard Dokter loaded successfully!');
        });
    </script>
</body>
</html>