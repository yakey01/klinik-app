                    ...
                    @if($financial['growth']['revenue'] != 0)
                        <div class="flex items-center space-x-1 text-sm">
                            @if($financial['growth']['revenue'] > 0)
                                ...
                                <span class="text-emerald-600 font-medium">+{{ $financial['growth']['revenue'] }}%</span>
                            @else
                                <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 7l-9.2 9.2M7 7v10h10"></path>
                                </svg>
                                <span class="text-red-600 font-medium">{{ $financial['growth']['revenue'] }}%</span>
                            @endif
                        </div>
                    @endif
                </div>
                    ...
                    @if($financial['growth']['expenses'] != 0)
                        <div class="flex items-center space-x-1 text-sm">
                            @if($financial['growth']['expenses'] > 0)
                                ...
                                <span class="text-red-600 font-medium">+{{ $financial['growth']['expenses'] }}%</span>
                            @else
                                <svg class="w-4 h-4 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 7l-9.2 9.2M7 7v10h10"></path>
                                </svg>
                                <span class="text-emerald-600 font-medium">{{ $financial['growth']['expenses'] }}%</span>
                            @endif
                        </div>
                    @endif
                </div>
                    ...
                    @if($financial['growth']['net_income'] != 0)
                        <div class="flex items-center space-x-1 text-sm">
                            @if($financial['growth']['net_income'] > 0)
                                ...
                                <span class="text-emerald-600 font-medium">+{{ $financial['growth']['net_income'] }}%</span>
                            @else
                                <svg class="w-4 h-4 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 7l-9.2 9.2M7 7v10h10"></path>
                                </svg>
                                <span class="text-red-600 font-medium">{{ $financial['growth']['net_income'] }}%</span>
                            @endif
                        </div>
                    @endif
                </div>
