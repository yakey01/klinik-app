<x-filament-widgets::widget>
    <x-filament::section>
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400">
                    Current month overview with growth trends
                </p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div class="stat-card revenue-card">
                ...
                <div class="stat-growth {{ $stats['revenue']['color'] }}">
                    ...
                    @endif
                    <span>{{ abs($stats['revenue']['growth']) }}%</span>
                </div>
            ...
            <div class="stat-card patients-card">
                ...
                <div class="stat-growth {{ $stats['patients']['color'] }}">
                    @if($stats['patients']['growth'] >= 0)
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 17l9.2-9.2M17 17V7H7"/>
                        </svg>
                    @else
                    ...
                    @endif
                    <span>{{ abs($stats['patients']['growth']) }}%</span>
                </div>
                <div class="stat-detail">
            ...
            <div class="stat-card procedures-card">
                ...
                <div class="stat-growth {{ $stats['procedures']['color'] }}">
                    @if($stats['procedures']['growth'] >= 0)
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 17l9.2-9.2M17 17V7H7"/>
                        </svg>
                    @else
                    ...
                    @endif
                    <span>{{ abs($stats['procedures']['growth']) }}%</span>
                </div>
                <div class="stat-detail">
            ...
            <div class="stat-card staff-card">
                ...
                <div class="stat-growth {{ $stats['staff']['color'] }}">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <style>
        ...
        .stat-growth.success { color: #10B981; }
        .stat-growth.danger { color: #EF4444; }
        .stat-growth.warning { color: #F59E0B; }
