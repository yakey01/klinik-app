            ...
            <div class="p-4 lg:p-8 space-y-8 animate-fade-in">
                ...
                <div class="animate-bounce-in" style="animation-delay: 0.6s">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <button class="glass rounded-xl p-6 text-center hover:bg-opacity-10 hover:bg-green-500 transition-all duration-300 group">
                        ...
                        <button class="glass rounded-xl p-6 text-center hover:bg-opacity-10 hover:bg-purple-500 transition-all duration-300 group">
