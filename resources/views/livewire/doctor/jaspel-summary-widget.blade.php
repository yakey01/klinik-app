<div class="bg-white rounded-lg shadow-sm p-6">
    <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-semibold text-gray-900">Ringkasan Jaspel</h3>
    ...
    @else
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-blue-50 rounded-lg p-4">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-blue-600">Total Bulan Ini</p>
        ...
        <div class="mt-6">
            ...
            <div class="bg-gray-50 rounded-lg p-4">
                <canvas id="jaspelTrendChart" class="w-full" height="150"></canvas>
            </div>
        </div>
    @endif
    ...
    <script>
        document.addEventListener('livewire:load', function () {
            const ctx = document.getElementById('jaspelTrendChart').getContext('2d');
