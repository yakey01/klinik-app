<div class="bg-white rounded-lg shadow-sm">
    ...
    <div class="px-6 py-4 border-b border-gray-200">
        <div class="flex items-center justify-between">
            <h3 class="text-lg font-semibold text-gray-900">Riwayat Jaspel Paramedis</h3>
    ...
    <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
        <div class="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div>
                ...
                <select wire:model="shiftFilter" class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse($jaspelRecords as $jaspel)
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            @if($jaspel->tindakan && $jaspel->tindakan->shift)
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                    @if($jaspel->tindakan->shift->nama_shift === 'Pagi') bg-yellow-100 text-yellow-800
                                    @elseif($jaspel->tindakan->shift->nama_shift === 'Sore') bg-orange-100 text-orange-800
                                    @else bg-gray-100 text-gray-800
                                    @endif">
                                    {{ $jaspel->tindakan->shift->nama_shift }}
                                </span>
                            @else
