...
class ValidationWorkflowIntegrationTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // Create roles first
        $petugasRole = \App\Models\Role::create(['name' => 'petugas', 'label' => 'Petugas']);
        $bendaharaRole = \App\Models\Role::create(['name' => 'bendahara', 'label' => 'Bendahara']);
        $dokterRole = \App\Models\Role::create(['name' => 'dokter', 'label' => 'Dokter']);
        $adminRole = \App\Models\Role::create(['name' => 'admin', 'label' => 'Admin']);
